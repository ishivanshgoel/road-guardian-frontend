      ...
      <div className="row" style={{ height: "100vh", margin: 0 }}>
        <div className="col-12 d-flex flex-column px-20">
          ...
          <div className="d-flex justify-content-center my-2">
            ...
            <button onClick={removeLastPhoto} className="btn btn-primary my-2 mx-2">
              Clear
            </button>
            <button onClick={toggleFormShow} className="btn btn-warning my-2 mx-2">
              Proceed
            </button>
          </div>
          <div className="d-flex justify-content-center flex-wrap">
            {allPictures &&
              allPictures.map((p, index) => <img className="m-2 rounded border border-warning" src={p} key={index} height={200} width={200} />)}
          </div>
        </div>
      </div>
    </div>
